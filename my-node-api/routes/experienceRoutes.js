...
const { createExperience, getExperience, delUserExp, delExp, getExperienceById, useInviteCode, getExistExperience, addProductInExp, updateExperience, getArchieveExperience, ArchieveExperience, UnarchieveExperience, sendInviteEmail } = require("../controllers/experienceControlers");
...
router.post("/invite", auth, sendInviteEmail);
