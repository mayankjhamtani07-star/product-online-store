export const UserAvatar = ({ size = 40 }) => (
    <svg viewBox="0 0 48 48" height={size} width={size} preserveAspectRatio="xMidYMid meet" fill="none">
